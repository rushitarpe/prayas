...
const TaskFilter = ({ onFilterChange, currentFilters, searchQuery = '', onSearchChange }) => {
        ...
        <div className="mb-5">
          <div className="relative">
            ...
            <input
              ...
              className="block w-full pl-10 pr-10 py-2.5 rounded-xl bg-gray-900/60 border border-gray-700 text-white text-sm placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all"
            />
            {searchQuery && (
              <button
                type="button"
